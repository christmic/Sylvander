//! Provider content adapter contract tests.
...
fn response_table_preserves_stop_usage_and_provider_boundary() {
    for (reason, expected, sequence) in [
        (
            core::StopReason::EndTurn,
            anthropic_wire::StopReason::EndTurn,
            None,
        ),
        (
            core::StopReason::ToolUse,
            anthropic_wire::StopReason::ToolUse,
            None,
        ),
        (
            core::StopReason::MaxOutputTokens,
            anthropic_wire::StopReason::MaxTokens,
            None,
        ),
        (
            core::StopReason::Refusal,
            anthropic_wire::StopReason::Refusal,
            None,
        ),
        (
            core::StopReason::Paused,
            anthropic_wire::StopReason::PauseTurn,
            None,
        ),
        (
            core::StopReason::StopSequence("END".into()),
            anthropic_wire::StopReason::StopSequence,
            Some("END"),
        ),
    ] {
