...
| A14 | MCP | partial | Production composition starts configured MCP stdio servers, initializes them, discovers namespaced tools, executes calls with timeouts, and shuts them down. Supervision, reconnect, resources/prompts, remote transports, and health remain. |
