...
//!
//! Sylvander Anthropic Protocol SDK — focused Rust wrapper for the
//! Anthropic Messages API.
//!
//! It implements the wire format for:
//!
...
//! agents platform. Runtime owns model routing, credential leases, and
//! provider lifecycle.
//!
//! ## Quickstart
//!
